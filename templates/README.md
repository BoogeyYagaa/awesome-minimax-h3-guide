...
> Adapted from [Flaq AI, `9fed21c`](https://github.com/flaqai/awesome-minimax-h3-video-prompts/blob/9fed21c196ffa5495b8f6d8de29cc77ba71eb66d/templates/README.md), copyright 2026 Flaq AI, [MIT](../licenses/Flaq-AI-MIT.txt). Imported 2026-09-21; original technical review dates are retained. Navigation is adapted for Flyne AI.
...
Return to the [prompt library](../prompts/README.md), read the [prompting guide](../docs/prompting-guide.md), or review the [H3 overview and official links](../docs/model-guide.md).
