...
[Flyne workflow guide](./workflows.md) · [Model guide](./model-guide.md) · [Prompt library](../prompts/README.md)
...
| Official source: [music-video subtitle skill](https://github.com/MiniMax-AI/MiniMax-H3/tree/main/skills/mv-subtitle-skill-confirmed) | Official source: [co-op game intro skill](https://github.com/MiniMax-AI/MiniMax-H3/tree/main/skills/co-op-game-intro-generator) |
...
官方视频用于学习镜头和参考素材的组织方法，不是 FlyneAI 的生成记录。文生视频、首尾帧生成、多素材参考的接口参数，以所选工具为准。

Editorial gallery adapted from Flaq AI under MIT; see [attribution](../THIRD_PARTY_NOTICES.md). Official media remain with MiniMax and are linked remotely. No official video is redistributed or claimed as a Flyne output.
