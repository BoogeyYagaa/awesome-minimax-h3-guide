...
> Adapted from [Flaq AI, `9fed21c`](https://github.com/flaqai/awesome-minimax-h3-video-prompts/blob/9fed21c196ffa5495b8f6d8de29cc77ba71eb66d/docs/api-workflow.md), copyright 2026 Flaq AI, [MIT](../licenses/Flaq-AI-MIT.txt). Imported 2026-09-21; original technical review dates are retained. Navigation is adapted for Flyne AI.
...
Return to the [main README](../README.md), read the [H3 overview](./model-guide.md), or follow the [deployment guide](./deployment-guide.md).
