...
[Choisir selon le résultat attendu](docs/use-case-matrix.md) · [Exemples multilingues](docs/multilingual-prompting.md) · [Intégration API](docs/api-workflow.md)

## Utiliser MiniMax H3 sur Flyne AI

| Accès recommandé dans le navigateur | Essai gratuit en ligne |
|---|---|
| [MiniMax H3](https://flyne.ai/model/minimax-h3/) | [Tester directement en ligne](https://flyne.ai/free-minimax-h3/) |

La page annonce un accès sans inscription. Le 2026-09-21, l’interface gratuite affichait des réglages de **5 secondes et 480p**. Commencez par les [exercices de cinq secondes](docs/quick-start.md).
