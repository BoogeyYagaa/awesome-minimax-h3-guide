...
> Adapted from [Flaq AI, `9fed21c`](https://github.com/flaqai/awesome-minimax-h3-video-prompts/blob/9fed21c196ffa5495b8f6d8de29cc77ba71eb66d/docs/deployment-guide.md), copyright 2026 Flaq AI, [MIT](../licenses/Flaq-AI-MIT.txt). Imported 2026-09-21; original technical review dates are retained. Navigation is adapted for Flyne AI.
...
Upstream last verified: 2026-08-06 against the official [MiniMax-AI/MiniMax-H3 repository](https://github.com/MiniMax-AI/MiniMax-H3) and [SGLang MiniMax-H3 cookbook](https://docs.sglang.io/cookbook/diffusion/MiniMax/MiniMax-H3).
...
Diffusers 用户可通过 ModularPipeline.from_pretrained("MiniMaxAI/MiniMax-H3") 按流水线加载所需组件，不必预先下载全部任务分支。具体加载方式以 [Diffusers H3 文档](https://github.com/huggingface/diffusers/blob/minimax-h3/docs/source/en/api/pipelines/minimax_h3.md)为准。
...
四张 H100 80 GB、两张 RTX 5090 或其他拓扑不要直接套用上述并行参数。请从 [SGLang H3 硬件选择器和已验证配置](https://docs.sglang.io/cookbook/diffusion/MiniMax/MiniMax-H3#3-serve-minimax-h3)复制对应命令。
...
| Diffusers | Python 流水线、实验和组件级开发 | [H3 pipeline docs](https://github.com/huggingface/diffusers/blob/minimax-h3/docs/source/en/api/pipelines/minimax_h3.md) |
